    ...
    <div className="fixed inset-0 pointer-events-none" style={{ zIndex: 9999 }}>
      ...
      <div ref={cursorRef} className="absolute" style={{ left: 0, top: 0 }}>
        <div className={`transition-opacity duration-150 ${snapped ? 'opacity-0' : 'opacity-100'}`}>
          {/* Vertical line */}
          <div className="absolute w-[0.5px]" style={{ left: -0.25, top: -LINE, height: LINE * 2, background: 'rgba(255,255,255,0.12)' }} />
          {/* Horizontal line */}
          <div className="absolute h-[0.5px]" style={{ top: -0.25, left: -LINE, width: LINE * 2, background: 'rgba(255,255,255,0.12)' }} />
          {/* Glow */}
          <div
          ...
          />
          {/* Center dot */}
          <div className="absolute w-1 h-1 rounded-full -translate-x-1/2 -translate-y-1/2" style={{ background: 'rgba(255,255,255,0.35)' }} />
        </div>
      </div>
      ...
      {snapped && snapRect && (
        ...
        >
          ...
          >
            <div className="absolute -top-0.5 left-1 w-3 h-3 border-t border-l rounded-tl-sm" style={{ borderColor: 'rgba(255,255,255,0.25)' }} />
            <div className="absolute -top-0.5 right-1 w-3 h-3 border-t border-r rounded-tr-sm" style={{ borderColor: 'rgba(255,255,255,0.25)' }} />
            <div className="absolute -bottom-0.5 left-1 w-3 h-3 border-b border-l rounded-bl-sm" style={{ borderColor: 'rgba(255,255,255,0.25)' }} />
            <div className="absolute -bottom-0.5 right-1 w-3 h-3 border-b border-r rounded-br-sm" style={{ borderColor: 'rgba(255,255,255,0.25)' }} />
          </div>
        </div>
      )}
    </div>
